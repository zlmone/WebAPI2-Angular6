...
var SkillService = (function () {
    ...
    SkillService.prototype.get = function (url) {
        return this._http.get(url)
            .map(function (response) { return response.json(); });
    };
    SkillService.prototype.post = function (url, model) {
    ...
    SkillService.prototype.put = function (url, Id, model) {
        var body = JSON.stringify(model);
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var options = new http_1.RequestOptions({ headers: headers });
    ...
    SkillService.prototype.delete = function (url, Id) {
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var options = new http_1.RequestOptions({ headers: headers });
