...
var CompanyMasterService = (function () {
    function CompanyMasterService(_http) {
        this._http = _http;
    }
    CompanyMasterService.prototype.get = function (url) {
        return this._http.get(url + '')
            .map(function (response) { return response.json(); });
    };
    CompanyMasterService.prototype.getFY = function (url) {
        return this._http.get(url + 'GetFYdllData')
            .map(function (response) { return response.json(); });
    };
    CompanyMasterService.prototype.getCountry = function (url) {
        return this._http.get(url + 'GetCountrydllData')
            .map(function (response) { return response.json(); });
    };
    CompanyMasterService.prototype.getDesignation = function (url) {
        return this._http.get(url + 'GetDesignationdllData')
            .map(function (response) { return response.json(); });
    };
    CompanyMasterService.prototype.getHead = function (url) {
        return this._http.get(url + 'SelectHead')
            .map(function (response) { return response.json(); });
    };
    CompanyMasterService.prototype.post = function (url, model) {
    ...
    CompanyMasterService.prototype.put = function (url, id, model) {
        var body = JSON.stringify(model);
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var options = new http_1.RequestOptions({ headers: headers });
    ...
    CompanyMasterService.prototype.delete = function (url, id) {
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var options = new http_1.RequestOptions({ headers: headers });
