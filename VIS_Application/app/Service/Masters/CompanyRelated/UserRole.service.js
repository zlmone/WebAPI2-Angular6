...
var UserRoleService = (function () {
    ...
    UserRoleService.prototype.get = function (url) {
        debugger;
        return this._http.get(url)
            .map(function (response) { return response.json(); });
    };
    UserRoleService.prototype.post = function (url, model) {
    ...
    UserRoleService.prototype.put = function (url, id, model) {
        var body = JSON.stringify(model);
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var options = new http_1.RequestOptions({ headers: headers });
    ...
    UserRoleService.prototype.delete = function (url, id) {
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var options = new http_1.RequestOptions({ headers: headers });
