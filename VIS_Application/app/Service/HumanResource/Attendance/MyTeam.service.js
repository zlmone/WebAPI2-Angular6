...
var MyTeamService = (function () {
    function MyTeamService(_http) {
        this._http = _http;
    }
    MyTeamService.prototype.get = function (url) {
        return this._http.get(url)
            .map(function (response) { return response.json(); });
    };
    MyTeamService.prototype.GetMyTeam = function (url, UserId) {
        return this._http.get(url + 'GetMyTeam?UserId=' + UserId)
            .map(function (response) { return response.json(); });
    };
    MyTeamService.prototype.GetLinemanager = function (url, id) {
        return this._http.get(url + 'GetLinemanager?id=' + id)
            .map(function (response) { return response.json(); });
    };
    MyTeamService.prototype.GetSkill = function (url, SkillID) {
        return this._http.get(url + 'GetSkill?SkillID=' + SkillID)
            .map(function (response) { return response.json(); });
    };
    MyTeamService.prototype.GetHoverPopup = function (url, UserId) {
        return this._http.get(url + 'GetHoverPopup?UserId=' + UserId)
            .map(function (response) { return response.json(); });
    };
    MyTeamService.prototype.post = function (url, model) {
    ...
    MyTeamService.prototype.put = function (url, id, model) {
        var body = JSON.stringify(model);
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var options = new http_1.RequestOptions({ headers: headers });
    ...
    MyTeamService.prototype.delete = function (url, id) {
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var options = new http_1.RequestOptions({ headers: headers });
