...
var MyActionRFQcomponent = (function () {
    function MyActionRFQcomponent(fb, _RFQService, router, pagerService, route) {
    ...
    MyActionRFQcomponent.prototype.ngOnInit = function () {
        debugger;
        ////////////////
        //this.sub = this.route
        //    .queryParams
    ...
    MyActionRFQcomponent.prototype.RFQFilterCriteriaChange = function (value) {
        if (value != '[object Event]')
            this.RFQFilter = value;
    };
    MyActionRFQcomponent.prototype.RFQSort = function (property) {
    ...
    ;
    MyActionRFQcomponent.prototype.LoadRFQs = function () {
        var _this = this;
        debugger;
        var UserName = sessionStorage.getItem('VISUsername');
        var UserType = sessionStorage.getItem('UserType');
        this.indLoading = true;
        this._RFQService.GetMyActionRFQ(global_1.Global.BASE_RFQ_ENDPOINT, UserName)
            ...
            if (_this.ShowHideSearch) {
                ...
                //}
                /////////
                _this.strsearchActionRequestedBy = document.getElementById("searchActionRequestedBy").value;
                if (_this.strsearchActionRequestedBy != '') {
                    _this.strsearchActionRequestedBy = _this.strsearchActionRequestedBy.toLocaleLowerCase();
                    _this.RFQs = _this.RFQs.filter(function (x) { return x.ActionRequestedBy != null && x.ActionRequestedBy.toLocaleLowerCase().indexOf(_this.strsearchActionRequestedBy) != -1; });
                }
                //////////
            }
    ...
    MyActionRFQcomponent.prototype.addRFQ = function () {
        this.router.navigate(['/AddRFQ']);
    };
    MyActionRFQcomponent.prototype.deleteRFQ = function (id, status) {
    ...
    MyActionRFQcomponent.prototype.SetControlsState = function (isEnable) {
        isEnable ? this.RFQFrm.enable() : this.RFQFrm.disable();
    };
    MyActionRFQcomponent.prototype.ChangeRecordsPerPage = function (RecordsPerPage) {
        this.CurrentRecordsPerPage = RecordsPerPage;
        if (RecordsPerPage >= 0) {
            this.JumpOnPage(1);
        }
    };
    MyActionRFQcomponent.prototype.JumpOnPage = function (PageNumber) {
        this.pagerService.setPage(PageNumber, this.CurrentRecordsPerPage, this.RFQs);
        this.pager = this.pagerService.pager;
        this.pagedItems = this.pagerService.pagedItems;
    };
    MyActionRFQcomponent.prototype.ShowHideSearchControls = function () {
        this.ShowHideSearch = !this.ShowHideSearch;
    };
    __decorate([
        core_1.ViewChild('modal'),
        __metadata("design:type", ng2_bs3_modal_1.ModalComponent)
    ], MyActionRFQcomponent.prototype, "modal", void 0);
    MyActionRFQcomponent = __decorate([
        core_1.Component({
            providers: [RFQ_service_1.RFQService],
            templateUrl: 'app/Components/RFQ/MyActionRFQ.component.html'
        }),
    ...
    ], MyActionRFQcomponent);
    return MyActionRFQcomponent;
}());
exports.MyActionRFQcomponent = MyActionRFQcomponent;
