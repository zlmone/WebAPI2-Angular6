...
export class MyActionRFQcomponent implements OnInit {
    ...
    LoadRFQs(): void {
        ...
        this._RFQService.GetMyActionRFQ(Global.BASE_RFQ_ENDPOINT, UserName)
            .subscribe(RFQs => {
                this.RFQs = RFQs;
                ...
                if (this.ShowHideSearch) {
                    ...
                    //}
                    /////////
                    this.strsearchActionRequestedBy = (<HTMLInputElement>document.getElementById("searchActionRequestedBy")).value;
