...
var MyWatchListRFQComponent = (function () {
    function MyWatchListRFQComponent(fb, _RFQService, router, pagerService, route) {
    ...
    MyWatchListRFQComponent.prototype.ngOnInit = function () {
        debugger;
        ////////////////
        //this.sub = this.route
        //    .queryParams
    ...
    MyWatchListRFQComponent.prototype.RFQFilterCriteriaChange = function (value) {
        if (value != '[object Event]')
            this.RFQFilter = value;
    };
    MyWatchListRFQComponent.prototype.RFQSort = function (property) {
    ...
    ;
    MyWatchListRFQComponent.prototype.LoadRFQs = function () {
        var _this = this;
        debugger;
        var UserName = sessionStorage.getItem('VISUsername');
        var UserType = sessionStorage.getItem('UserType');
        this.indLoading = true;
        this._RFQService.GetMyWatchListRFQ(global_1.Global.BASE_RFQ_ENDPOINT, UserName)
    ...
    MyWatchListRFQComponent.prototype.addRFQ = function () {
        this.router.navigate(['/AddRFQ']);
    };
    MyWatchListRFQComponent.prototype.deleteRFQ = function (id, status) {
    ...
    MyWatchListRFQComponent.prototype.SetControlsState = function (isEnable) {
        isEnable ? this.RFQFrm.enable() : this.RFQFrm.disable();
    };
    MyWatchListRFQComponent.prototype.ChangeRecordsPerPage = function (RecordsPerPage) {
        this.CurrentRecordsPerPage = RecordsPerPage;
        if (RecordsPerPage >= 0) {
            this.JumpOnPage(1);
        }
    };
    MyWatchListRFQComponent.prototype.JumpOnPage = function (PageNumber) {
        this.pagerService.setPage(PageNumber, this.CurrentRecordsPerPage, this.RFQs);
        this.pager = this.pagerService.pager;
        this.pagedItems = this.pagerService.pagedItems;
    };
    MyWatchListRFQComponent.prototype.ShowHideSearchControls = function () {
        this.ShowHideSearch = !this.ShowHideSearch;
    };
    __decorate([
        core_1.ViewChild('modal'),
        __metadata("design:type", ng2_bs3_modal_1.ModalComponent)
    ], MyWatchListRFQComponent.prototype, "modal", void 0);
    MyWatchListRFQComponent = __decorate([
        core_1.Component({
            providers: [RFQ_service_1.RFQService],
            templateUrl: 'app/Components/RFQ/MyWatchListRFQ.component.html'
        }),
    ...
    ], MyWatchListRFQComponent);
    return MyWatchListRFQComponent;
}());
exports.MyWatchListRFQComponent = MyWatchListRFQComponent;
