...
var RFQComponent = (function () {
    function RFQComponent(fb, _RFQService, router, pagerService, route) {
    ...
    RFQComponent.prototype.ngOnInit = function () {
        debugger;
        ////////////////
        //this.sub = this.route
        //    .queryParams
    ...
    RFQComponent.prototype.RFQFilterCriteriaChange = function (value) {
        if (value != '[object Event]')
            this.RFQFilter = value;
    };
    RFQComponent.prototype.RFQSort = function (property) {
        debugger;
    ...
    ;
    RFQComponent.prototype.LoadRFQs = function () {
        var _this = this;
        debugger;
        var UserName = sessionStorage.getItem('VISUsername');
        var UserType = sessionStorage.getItem('UserType');
        this.indLoading = true;
        this._RFQService.get(global_1.Global.BASE_RFQ_ENDPOINT, UserName)
    ...
    RFQComponent.prototype.addRFQ = function () {
        this.router.navigate(['/AddRFQ']);
    };
    RFQComponent.prototype.deleteRFQ = function (id, status) {
    ...
    RFQComponent.prototype.SetControlsState = function (isEnable) {
        isEnable ? this.RFQFrm.enable() : this.RFQFrm.disable();
    };
    RFQComponent.prototype.ChangeRecordsPerPage = function (RecordsPerPage) {
        this.CurrentRecordsPerPage = RecordsPerPage;
        if (RecordsPerPage >= 0) {
            this.JumpOnPage(1);
        }
    };
    RFQComponent.prototype.JumpOnPage = function (PageNumber) {
        this.pagerService.setPage(PageNumber, this.CurrentRecordsPerPage, this.RFQs);
        this.pager = this.pagerService.pager;
        this.pagedItems = this.pagerService.pagedItems;
    };
    RFQComponent.prototype.ShowHideSearchControls = function () {
        this.ShowHideSearch = !this.ShowHideSearch;
    };
    __decorate([
        core_1.ViewChild('modal'),
        __metadata("design:type", ng2_bs3_modal_1.ModalComponent)
    ], RFQComponent.prototype, "modal", void 0);
    RFQComponent = __decorate([
        core_1.Component({
            providers: [RFQ_service_1.RFQService],
            templateUrl: 'app/Components/RFQ/RFQEstimateListing.component.html'
        }),
...
exports.RFQComponent = RFQComponent;
