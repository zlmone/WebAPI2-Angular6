...
var ResponceRequestedRFQcomponent = (function () {
    function ResponceRequestedRFQcomponent(fb, _RFQService, router, pagerService, route) {
    ...
    ResponceRequestedRFQcomponent.prototype.ngOnInit = function () {
        debugger;
        ////////////////
        //this.sub = this.route
        //    .queryParams
    ...
    ResponceRequestedRFQcomponent.prototype.RFQFilterCriteriaChange = function (value) {
        if (value != '[object Event]')
            this.RFQFilter = value;
    };
    ResponceRequestedRFQcomponent.prototype.RFQSort = function (property) {
    ...
    ;
    ResponceRequestedRFQcomponent.prototype.LoadRFQs = function () {
        var _this = this;
        debugger;
        var UserName = sessionStorage.getItem('VISUsername');
        var UserType = sessionStorage.getItem('UserType');
        this.indLoading = true;
        this._RFQService.getResponceRequestedRFQ(global_1.Global.BASE_RFQ_ENDPOINT, UserName)
    ...
    ResponceRequestedRFQcomponent.prototype.addRFQ = function () {
        this.router.navigate(['/AddRFQ']);
    };
    ResponceRequestedRFQcomponent.prototype.deleteRFQ = function (id, status) {
    ...
    ResponceRequestedRFQcomponent.prototype.SetControlsState = function (isEnable) {
        isEnable ? this.RFQFrm.enable() : this.RFQFrm.disable();
    };
    ResponceRequestedRFQcomponent.prototype.ChangeRecordsPerPage = function (RecordsPerPage) {
        this.CurrentRecordsPerPage = RecordsPerPage;
        if (RecordsPerPage >= 0) {
            this.JumpOnPage(1);
        }
    };
    ResponceRequestedRFQcomponent.prototype.JumpOnPage = function (PageNumber) {
        this.pagerService.setPage(PageNumber, this.CurrentRecordsPerPage, this.RFQs);
        this.pager = this.pagerService.pager;
        this.pagedItems = this.pagerService.pagedItems;
    };
    ResponceRequestedRFQcomponent.prototype.ShowHideSearchControls = function () {
        this.ShowHideSearch = !this.ShowHideSearch;
    };
    __decorate([
        core_1.ViewChild('modal'),
        __metadata("design:type", ng2_bs3_modal_1.ModalComponent)
    ], ResponceRequestedRFQcomponent.prototype, "modal", void 0);
    ResponceRequestedRFQcomponent = __decorate([
        core_1.Component({
            providers: [RFQ_service_1.RFQService],
            templateUrl: 'app/Components/RFQ/ResponceRequestedRFQ.component.html'
        }),
    ...
    ], ResponceRequestedRFQcomponent);
    return ResponceRequestedRFQcomponent;
}());
exports.ResponceRequestedRFQcomponent = ResponceRequestedRFQcomponent;
