...
var NewsFilterPipe = (function () {
    function NewsFilterPipe() {
    }
    NewsFilterPipe.prototype.transform = function (value, filter) {
        filter = filter ? filter.toLocaleLowerCase() : null;
        return filter ? value.filter(function (app) {
            return app.News_Name != null && app.News_Name.toLocaleLowerCase().indexOf(filter) != -1
                || app.Description != null && app.Description.toLocaleLowerCase().indexOf(filter) != -1;
        }) : value;
    };
    NewsFilterPipe = __decorate([
        core_1.Pipe({
            name: 'NewsFilter'
        })
    ], NewsFilterPipe);
...
exports.NewsFilterPipe = NewsFilterPipe;
/*
