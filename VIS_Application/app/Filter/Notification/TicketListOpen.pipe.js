...
var TicketListOpenFilterPipe = (function () {
    function TicketListOpenFilterPipe() {
    }
    TicketListOpenFilterPipe.prototype.transform = function (value, filter) {
    ...
    TicketListOpenFilterPipe = __decorate([
        core_1.Pipe({
            name: 'TicketListOpenFilter'
        })
    ], TicketListOpenFilterPipe);
    return TicketListOpenFilterPipe;
}());
exports.TicketListOpenFilterPipe = TicketListOpenFilterPipe;
/*
