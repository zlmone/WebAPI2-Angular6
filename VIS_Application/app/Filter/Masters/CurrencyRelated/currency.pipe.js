...
var CurrencyFilterPipe = (function () {
    function CurrencyFilterPipe() {
    }
    CurrencyFilterPipe.prototype.transform = function (value, filter) {
        filter = filter ? filter.toLocaleLowerCase() : null;
        return filter ? value.filter(function (app) {
            return app.Full_Name != null && app.Full_Name.toLocaleLowerCase().indexOf(filter) != -1
...
exports.CurrencyFilterPipe = CurrencyFilterPipe;
/*
