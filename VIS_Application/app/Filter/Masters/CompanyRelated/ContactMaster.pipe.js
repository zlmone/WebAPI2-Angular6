...
var ContactMasterFilterPipe = (function () {
    function ContactMasterFilterPipe() {
    }
    ContactMasterFilterPipe.prototype.transform = function (value, filter) {
    ...
    ContactMasterFilterPipe = __decorate([
        core_1.Pipe({
            name: 'contactmasterFilter'
        })
    ], ContactMasterFilterPipe);
    return ContactMasterFilterPipe;
}());
exports.ContactMasterFilterPipe = ContactMasterFilterPipe;
/*
