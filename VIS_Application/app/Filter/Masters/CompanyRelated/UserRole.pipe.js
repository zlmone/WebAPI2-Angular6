...
var UserRoleFilterPipe = (function () {
    function UserRoleFilterPipe() {
    }
    UserRoleFilterPipe.prototype.transform = function (value, filter) {
    ...
    UserRoleFilterPipe = __decorate([
        core_1.Pipe({
            name: 'UserRoleFilter'
        })
    ], UserRoleFilterPipe);
    return UserRoleFilterPipe;
}());
exports.UserRoleFilterPipe = UserRoleFilterPipe;
