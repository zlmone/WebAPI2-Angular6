...
var CompanyMasterFilterPipe = (function () {
    function CompanyMasterFilterPipe() {
    }
    CompanyMasterFilterPipe.prototype.transform = function (value, filter) {
    ...
    CompanyMasterFilterPipe = __decorate([
        core_1.Pipe({
            name: 'CompanyMasterFilter'
        })
    ], CompanyMasterFilterPipe);
    return CompanyMasterFilterPipe;
}());
exports.CompanyMasterFilterPipe = CompanyMasterFilterPipe;
/*
