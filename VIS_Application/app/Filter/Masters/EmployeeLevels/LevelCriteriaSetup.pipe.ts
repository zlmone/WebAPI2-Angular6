...
export class LevelCriteriaSetupFilterPipe implements PipeTransform {

    transform(value: ILevelCriteriaSetup[], filter: string): ILevelCriteriaSetup[] {
        filter = filter ? filter.toLocaleLowerCase() : null;
        return filter ? value.filter((app: ILevelCriteriaSetup) =>
