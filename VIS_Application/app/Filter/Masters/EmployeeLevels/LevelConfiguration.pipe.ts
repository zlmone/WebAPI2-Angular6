...
export class LevelConfigurationFilterPipe implements PipeTransform {

    transform(value: ILevelConfiguration[], filter: string): ILevelConfiguration[] {
        filter = filter ? filter.toLocaleLowerCase() : null;
        return filter ? value.filter((app: ILevelConfiguration) =>
            app.PeriodName != null && app.PeriodName.toLocaleLowerCase().indexOf(filter) != -1
