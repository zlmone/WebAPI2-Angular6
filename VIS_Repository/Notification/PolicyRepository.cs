...
{
    public class PolicyRepository : VISDbCommand, VISIBaseRepository<Policy>
    {
        public Int32 intAffectedRecords { get; set; }


        public PolicyRepository(string _connectionstring) : base(_connectionstring)
        {
        }
        ...
        public string DeleteEntity(Int64 Id)
        {
            ...
            try
            {
                ...
                objVISDbCommand.objSqlCommand.CommandText = PolicyConstants.const_procPolicy_ActiveInActive;
        ...
        public Policy GetEntityByID(Int64 entityId)
        {
            Policy objEntityToReturn = new Policy();
            using (base.objSqlCommand.Connection)
            {
                base.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                base.objSqlCommand.CommandText = PolicyConstants.const_procPolicy_SelectById;
                ...
                da.Fill(dt);
                objEntityToReturn = VISAutoMapper.ConvertDataRow<Policy>(dt.Rows[0]);
            }
            return objEntityToReturn;
        }

        public IEnumerable<Policy> GetEntityList()
        {
            List<Policy> objListToReturn = new List<Policy>();
            using (base.objSqlCommand.Connection)
            {
                base.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                base.objSqlCommand.CommandText = PolicyConstants.const_procPolicy_SelectAll;
                if (base.objSqlCommand.Connection.State != ConnectionState.Open)
                {
                    base.objSqlCommand.Connection.Open();
                }
                ...
                DataTable dt = new DataTable();
                da.Fill(dt);
                objListToReturn = VISAutoMapper.ConvertDataTable<Policy>(dt);
            }
            return objListToReturn;

        }

        public string AddEntity(Policy entityObject)
        {
            try
            {
                VISDbCommand objVISDbCommand = new VISDbCommand(base.DatabaseConnection.ConnectionString);
                objVISDbCommand.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                objVISDbCommand.objSqlCommand.CommandText = PolicyConstants.const_procPolicy_Add;

                objVISDbCommand.objSqlCommand.Parameters.AddWithValue(PolicyConstants.const_Field_Policy_Name, entityObject.Policy_Name);
                objVISDbCommand.objSqlCommand.Parameters.AddWithValue(PolicyConstants.const_Field_Description, entityObject.Description);
                objVISDbCommand.objSqlCommand.Parameters.AddWithValue(PolicyConstants.const_Field_IsNewPolicy, entityObject.IsNewPolicy);
        ...
        public string UpdateEntity(Policy entityObject)
        {
            try
            {
                VISDbCommand objVISDbCommand = new VISDbCommand(base.DatabaseConnection.ConnectionString);
                objVISDbCommand.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                objVISDbCommand.objSqlCommand.CommandText = PolicyConstants.const_procPolicy_Update;
        ...
        public IEnumerable<Policy> GetViewPolicy(Int64 Id)
        {
            List<Policy> objListToReturn = new List<Policy>();
            List<Policy> objListToReturn1 = new List<Policy>();
            using (base.objSqlCommand.Connection)
            {
                base.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                base.objSqlCommand.CommandText = PolicyConstants.const_procPolicy_View;
                ...
                da.Fill(dt);
                objListToReturn = VISAutoMapper.ConvertDataTable<Policy>(dt);
                foreach (var item in objListToReturn)
                {

                    System.Text.RegularExpressions.Regex rx = new System.Text.RegularExpressions.Regex("<[^>]*>");
                    string str = rx.Replace(item.Description, "");
                    System.Text.RegularExpressions.Regex rx1 = new System.Text.RegularExpressions.Regex("&nbsp;");
                    string str1 = rx1.Replace(str, "");
                    objListToReturn1.Add(new Policy { Description = str1, Policy_Name = item.Policy_Name });
