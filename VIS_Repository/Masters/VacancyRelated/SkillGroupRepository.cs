...
{
    public class SkillGroupRepository : VISDbCommand, VISIBaseRepository<SkillGroup>
    {

        public Int32 intAffectedRecords { get; set; }


        public SkillGroupRepository(string _connectionstring) : base(_connectionstring)
        {
        ...
        public string DeleteEntity(Int64 Id)
        {
            ...
            try
            {
                ...
                objVISDbCommand.objSqlCommand.CommandText = SkillGroupConstant.const_procSkillGroup_ActiveInActive;
        ...
        public SkillGroup GetEntityByID(Int64 SkillGroupID)
        {
            SkillGroup objEntityToReturn = new SkillGroup();

            using (base.objSqlCommand.Connection)
            {
                base.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                base.objSqlCommand.CommandText = SkillGroupConstant.const_procSkillGroup_SelectById;
                base.objSqlCommand.Parameters.AddWithValue(SkillGroupConstant.const_SkillGroupID, SkillGroupID);
                ...
                da.Fill(dt);
                objEntityToReturn = VISAutoMapper.ConvertDataRow<SkillGroup>(dt.Rows[0]);
            }
            return objEntityToReturn;
        }

        public IEnumerable<SkillGroup> GetEntityList()
        {
            List<SkillGroup> objListToReturn = new List<SkillGroup>();
            using (base.objSqlCommand.Connection)
            {
                base.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                base.objSqlCommand.CommandText = SkillGroupConstant.const_procSkillGroup_SelectAll;
                if (base.objSqlCommand.Connection.State != ConnectionState.Open)
                {
                    base.objSqlCommand.Connection.Open();
                }
                ...
                DataTable dt = new DataTable();
                da.Fill(dt);
                objListToReturn = VISAutoMapper.ConvertDataTable<SkillGroup>(dt);
            }
            return objListToReturn;

        }

        public string AddEntity(SkillGroup entityObject)
        {
            try
            {
                VISDbCommand objVISDbCommand = new VISDbCommand(base.DatabaseConnection.ConnectionString);
                objVISDbCommand.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                objVISDbCommand.objSqlCommand.CommandText = SkillGroupConstant.const_procSkillGroup_Add;

                objVISDbCommand.objSqlCommand.Parameters.AddWithValue(SkillGroupConstant.const_SkillGroupName, entityObject.SkillGroupName);
                objVISDbCommand.objSqlCommand.Parameters.AddWithValue(SkillGroupConstant.const_RatingGroup, entityObject.RatingGroup);
        ...
        public string UpdateEntity(SkillGroup entityObject)
        {
            try
            {
                VISDbCommand objVISDbCommand = new VISDbCommand(base.DatabaseConnection.ConnectionString);
                objVISDbCommand.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                objVISDbCommand.objSqlCommand.CommandText = SkillGroupConstant.const_procSkillGroup_Update;
