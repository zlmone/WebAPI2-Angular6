...
{
    public class RatingTypeRepository : VISDbCommand, VISIBaseRepository<RatingType>
    {

        public Int32 intAffectedRecords { get; set; }


        public RatingTypeRepository(string _connectionstring) : base(_connectionstring)
        {
        ...
        public string DeleteEntity(Int64 Id)
        {
            ...
            try
            {
                ...
                objVISDbCommand.objSqlCommand.CommandText = RatingTypeConstant.const_procRatingType_ActiveInActive;
        ...
        public RatingType GetEntityByID(Int64 entityId)
        {
            RatingType objEntityToReturn = new RatingType();
            using (base.objSqlCommand.Connection)
            {
                base.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                base.objSqlCommand.CommandText = RatingTypeConstant.const_procRatingType_SelectById;
                ...
                da.Fill(dt);
                objEntityToReturn = VISAutoMapper.ConvertDataRow<RatingType>(dt.Rows[0]);
            }
            return objEntityToReturn;
        }

        public IEnumerable<RatingType> GetEntityList()
        {
            List<RatingType> objListToReturn = new List<RatingType>();
            using (base.objSqlCommand.Connection)
            {
                base.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                base.objSqlCommand.CommandText = RatingTypeConstant.const_procRatingType_SelectAll;
                if (base.objSqlCommand.Connection.State != ConnectionState.Open)
                {
                    base.objSqlCommand.Connection.Open();
                }
                ...
                DataTable dt = new DataTable();
                da.Fill(dt);
                objListToReturn = VISAutoMapper.ConvertDataTable<RatingType>(dt);
            }
            return objListToReturn;

        }

        public string AddEntity(RatingType entityObject)
        {
            try
            {
                VISDbCommand objVISDbCommand = new VISDbCommand(base.DatabaseConnection.ConnectionString);
                objVISDbCommand.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                objVISDbCommand.objSqlCommand.CommandText = RatingTypeConstant.const_procRatingType_Add;

                objVISDbCommand.objSqlCommand.Parameters.AddWithValue(RatingTypeConstant.const_TypeName, entityObject.TypeName);
        ...
        public string UpdateEntity(RatingType entityObject)
        {
            try
            {
                VISDbCommand objVISDbCommand = new VISDbCommand(base.DatabaseConnection.ConnectionString);
                objVISDbCommand.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                objVISDbCommand.objSqlCommand.CommandText = RatingTypeConstant.const_procRatingType_Update;
