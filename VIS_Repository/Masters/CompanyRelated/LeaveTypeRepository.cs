...
{
    public class LeaveTypeRepository : VISDbCommand, VISIBaseRepository<LeaveType>
    {

        public Int32 intAffectedRecords { get; set; }


        public LeaveTypeRepository(string _connectionstring) : base(_connectionstring)
        {
        ...
        public string DeleteEntity(Int64 Id)
        {
            ...
            try
            {
                ...
                objVISDbCommand.objSqlCommand.CommandText = LeaveTypeConstant.const_procLeaveType_ActiveInActive;
        ...
        public LeaveType GetEntityByID(Int64 entityId)
        {
            LeaveType objEntityToReturn = new LeaveType();
            using (base.objSqlCommand.Connection)
            {
                base.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                base.objSqlCommand.CommandText = LeaveTypeConstant.const_procLeaveType_SelectById;
                ...
                da.Fill(dt);
                objEntityToReturn = VISAutoMapper.ConvertDataRow<LeaveType>(dt.Rows[0]);
            }
            return objEntityToReturn;
        }

        public IEnumerable<LeaveType> GetEntityList()
        {
            List<LeaveType> objListToReturn = new List<LeaveType>();
            using (base.objSqlCommand.Connection)
            {
                base.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                base.objSqlCommand.CommandText = LeaveTypeConstant.const_procLeaveType_SelectAll;
                if (base.objSqlCommand.Connection.State != ConnectionState.Open)
                {
                    base.objSqlCommand.Connection.Open();
                }
                ...
                DataTable dt = new DataTable();
                da.Fill(dt);
                objListToReturn = VISAutoMapper.ConvertDataTable<LeaveType>(dt);
            }
            return objListToReturn;

        }

        public string AddEntity(LeaveType entityObject)
        {
            try
            {
                VISDbCommand objVISDbCommand = new VISDbCommand(base.DatabaseConnection.ConnectionString);
                objVISDbCommand.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                objVISDbCommand.objSqlCommand.CommandText = LeaveTypeConstant.const_procLeaveType_Add;

                objVISDbCommand.objSqlCommand.Parameters.AddWithValue(LeaveTypeConstant.const_LeaveType, entityObject.LeaveTypeName);
        ...
        public string UpdateEntity(LeaveType entityObject)
        {
            try
            {
                VISDbCommand objVISDbCommand = new VISDbCommand(base.DatabaseConnection.ConnectionString);
                objVISDbCommand.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                objVISDbCommand.objSqlCommand.CommandText = LeaveTypeConstant.const_procLeaveType_Update;
