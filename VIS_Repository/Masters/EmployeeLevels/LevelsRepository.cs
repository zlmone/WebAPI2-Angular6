...
{
    public class LevelsRepository : VISDbCommand, VISIBaseRepository<Levels>
    {
        public Int32 intAffectedRecords { get; set; }


        public LevelsRepository(string _connectionstring) : base(_connectionstring)
        {
        }
        ...
        public string DeleteEntity(Int64 Id)
        {
            ...
            try
            {
                ...
                objVISDbCommand.objSqlCommand.CommandText = LevelsConstants.const_procLevels_ActiveInActive;
        ...
        public Levels GetEntityByID(Int64 entityId)
        {
            Levels objEntityToReturn = new Levels();
            using (base.objSqlCommand.Connection)
            {
                base.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                base.objSqlCommand.CommandText = LevelsConstants.const_procLevels_SelectById;
                ...
                da.Fill(dt);
                objEntityToReturn = VISAutoMapper.ConvertDataRow<Levels>(dt.Rows[0]);
            }
            return objEntityToReturn;
        }

        public IEnumerable<Levels> GetEntityList()
        {
            List<Levels> objListToReturn = new List<Levels>();
            using (base.objSqlCommand.Connection)
            {
                base.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                base.objSqlCommand.CommandText = LevelsConstants.const_procLevels_SelectAll;
                if (base.objSqlCommand.Connection.State != ConnectionState.Open)
                {
                    base.objSqlCommand.Connection.Open();
                }
                ...
                DataTable dt = new DataTable();
                da.Fill(dt);
                objListToReturn = VISAutoMapper.ConvertDataTable<Levels>(dt);
            }
            return objListToReturn;

        }

        public string AddEntity(Levels entityObject)
        {
            try
            {
                VISDbCommand objVISDbCommand = new VISDbCommand(base.DatabaseConnection.ConnectionString);
                objVISDbCommand.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                objVISDbCommand.objSqlCommand.CommandText = LevelsConstants.const_procLevels_Add;
                objVISDbCommand.objSqlCommand.Parameters.AddWithValue(LevelsConstants.const_Field_EndPoint, entityObject.EndPoint);
                objVISDbCommand.objSqlCommand.Parameters.AddWithValue(LevelsConstants.const_Field_LevelIcon, entityObject.LevelIcon);
                objVISDbCommand.objSqlCommand.Parameters.AddWithValue(LevelsConstants.const_Field_LevelName, entityObject.LevelName);
                objVISDbCommand.objSqlCommand.Parameters.AddWithValue(LevelsConstants.const_Field_LevelNumber, entityObject.LevelNumber);
                objVISDbCommand.objSqlCommand.Parameters.AddWithValue(LevelsConstants.const_Field_StartPoint, entityObject.StartPoint);                
        ...
        public string UpdateEntity(Levels entityObject)
        {
            try
            {
                VISDbCommand objVISDbCommand = new VISDbCommand(base.DatabaseConnection.ConnectionString);
                objVISDbCommand.objSqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
                objVISDbCommand.objSqlCommand.CommandText = LevelsConstants.const_procLevels_Update;
